from CaseMap_CUDA import CaseMap #导入元胞自动机类
import numpy as np
...
def draw_pic(_data: np.array, cost: np.array, N: int):
    ...
    plt.savefig("img/Normal healthy people.png",dpi=800)
    plt.close()
    #plt.show()
    ...
    plt.savefig("img/Undetected infected people.png", dpi=800)
    plt.close()
    #plt.show()
    ...
    plt.ylabel("people counting")
    plt.title("Diagnosed")
    plt.savefig("img/Diagnosed.png", dpi=800)
    plt.close()
    #plt.show()
    ...
    plt.savefig("img/People with immunity.png", dpi=800)
    plt.close()
    #plt.show()
    ...
    plt.ylabel("people counting")
    plt.title("Death")
    plt.savefig("img/Death.png",dpi=800)
    plt.close()
    #plt.show()
    ...
    plt.savefig("img/Cost_Total.png",dpi=800)
    plt.close()
    #plt.show()
